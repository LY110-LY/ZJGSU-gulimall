...
import com.zjgsu.gulimall.product.dao.AttrDao;
...
//        AttrAttrgroupRelationEntity relationEntity1 = relationDao.selectById(attrId);
//        System.out.println("1"+relationEntity1);
//        AttrAttrgroupRelationEntity relationEntity = relationDao.selectOne(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id", attrId));
//        System.out.println("2"+relationEntity);
        //这两种方式出的结果一样，为什么用QueryWrapper
